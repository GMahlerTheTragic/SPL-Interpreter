...
import interpreter.visitor.SPLVisitor;
...
public class SPLParser extends Parser {
    ...
    public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, T__7 = 8, T__8 = 9,
            ...
            WS = 31, COMMENT = 32;
    public static final int RULE_program = 0, RULE_declaration = 1, RULE_varDecl = 2, RULE_statement = 3,
    ...
    public static class ProgramContext extends ParserRuleContext {
        ...
        public void accept(SPLVisitorImpl visitor) {
    ...
    public static class Logic_orContext extends ParserRuleContext {
        ...
        public Value accept(SPLVisitorImpl visitor) {
            if (visitor instanceof SPLVisitor) {
                return ((SPLVisitor) visitor).visitLogicOr(this);
            } else
    ...
    public static class Logic_andContext extends ParserRuleContext {
        ...
        public Value accept(SPLVisitorImpl visitor) {
            if (visitor instanceof SPLVisitor) {
                return ((SPLVisitor) visitor).visitLogicAnd(this);
            } else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class PrimaryContext extends ParserRuleContext {
        public TerminalNode NUMBER() {
            return getToken(SPLParser.NUMBER, 0);
        }

        public TerminalNode STRING() {
            return getToken(SPLParser.STRING, 0);
        }
